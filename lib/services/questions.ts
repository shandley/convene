...
export class QuestionsService {
  ...
  async duplicateQuestion(
    ...
    const newQuestionData: CreateQuestionRequest = {
      ...
      category_id: existingQuestion.category_id || undefined,
      help_text: existingQuestion.help_text || undefined,
      placeholder: existingQuestion.placeholder || undefined,
      required: existingQuestion.required ?? false,
      max_length: existingQuestion.max_length || undefined,
      ...
      max_file_size_mb: existingQuestion.max_file_size_mb || undefined,
      max_files: existingQuestion.max_files ?? 1,
      allow_other: existingQuestion.allow_other ?? false,
      randomize_options: existingQuestion.randomize_options ?? false,
