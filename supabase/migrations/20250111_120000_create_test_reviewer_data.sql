-- Create test reviewer setup for Convene workshop administration
-- This migration sets up a complete test environment for reviewer workflow testing
...
-- Add some review criteria questions to the Test Conference program
-- First, let's add key application questions that should be reviewed
